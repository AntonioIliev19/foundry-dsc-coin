...
contract DSCEngine is ReentrancyGuard {
     ...
     * @notice Follows cei
     * @param amountDscToMint  The amount of decentralized stablecoin to mint
     * @notice they must have more collateral v alue than the minimum threshold
     */
     ...
     * @param debtToCover The amount of DSC you want to burn to improve the users health factors
     * @notice You can partially liquidate a user.
     * @notice You will get a liquidation bonus for thaking the users funds
        ...
        nonReentrant
    {
        ...
        // we should implement a feature to liquidate in the vent the protocol is insolvent
     ...
     * If a user goew below 1, then they can get liquidated
     */
